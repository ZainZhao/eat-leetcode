...
- [x] 56 合并区间（排序+找左右端点）
- [x] 148 排序链表（收集+构造、PriorityQueue+构造、归并排序）
- [x] 179 最大数（Stram+(A+B>B+A)）
- [x] 215 数组中的第K个最大元素（API、PriorityQueue建堆、手写大根堆、手写快排）
- [x] 912 排序数组（手写各种排序算法）
- [x] 1122 数组的相对排序 （遍历+标记+拼接、桶排序）
- [x] 1365 有多少小于当前数字的数字（双重遍历、桶计数）
- [x] 剑指Offer 51 数组中的逆序对（TODO）
